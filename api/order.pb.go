...
const file_order_proto_rawDesc = "" +
	...
	".api.OrderR\x06orders2\xc0\x03\n" +
	"\fOrderService\x12W\n" +
	"\vCreateOrder\x12\x17.api.CreateOrderRequest\x1a\x18.api.CreateOrderResponse\"\x15\x82\xd3\xe4\x93\x02\x0f:\x01*\"\n" +
	"/v1/create\x12M\n" +
	"\bGetOrder\x12\x14.api.GetOrderRequest\x1a\x15.api.GetOrderResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/get/{id}\x12\\\n" +
	"\vUpdateOrder\x12\x17.api.UpdateOrderRequest\x1a\x18.api.UpdateOrderResponse\"\x1a\x82\xd3\xe4\x93\x02\x14:\x01*2\x0f/v1/update/{id}\x12Y\n" +
	"\vDeleteOrder\x12\x17.api.DeleteOrderRequest\x1a\x18.api.DeleteOrderResponse\"\x17\x82\xd3\xe4\x93\x02\x11*\x0f/v1/delete/{id}\x12O\n" +
	"\n" +
	"ListOrders\x12\x16.api.ListOrdersRequest\x1a\x17.api.ListOrdersResponse\"\x10\x82\xd3\xe4\x93\x02\n" +
	"\x12\b/v1/listB\x0eZ\fpkg/api/testb\x06proto3"
